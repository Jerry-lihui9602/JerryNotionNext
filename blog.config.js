...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '160a354db50f80649b50cd5d30d19c7f,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小灰', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个尝试全栈开发的后端程序员🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.opencontent.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ai, 博客, 全栈开发, 后端开发, 前端开发, 程序员, 探索者', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/2141505285', // B站主页
  ...
  BLOG_FAVICON: '/favicon.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'XIAOHUI BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '小灰的学习笔记', // 站点描述，被notion中的页面描述覆盖
